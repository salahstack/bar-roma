    ...
    <footer className='bg-roma-dark py-10'>
      <div className='container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
        <div className='pb-8 md:pb-0 border-b border-gray-600 md:border-none'>
          <h5 className='text-white text-4xl font-bold mb-1'>Bar Roma</h5>
        ...
        <div className='pb-8 md:pb-0 border-b border-gray-600 md:border-none'>
          <h5 className='text-white text-2xl font-bold'>Link rapidi</h5>
          <ul className='mt-8 text-gray-400 grid grid-cols-1 gap-3'>
            {navLinks.map(({ label, href }, index) => (
              <li key={index}>
                <a
                  className='font-medium transition-all active:scale-95 hover:text-roma-gold'
                  href={href}
                >
                  {label}
                </a>
        ...
        <div className='pb-8 md:pb-0 border-b border-gray-600 md:border-none'>
          <h5 className='text-white text-2xl font-bold'>Contatto</h5>
          <ul className='mt-8 text-gray-400 grid grid-cols-1 gap-3'>
